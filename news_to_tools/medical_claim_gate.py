...
HIGH_RISK_TERMS = {"诊断", "用药", "影像", "病历", "癌", "doctor", "clinical", "diagnosis", "medication"}
...
def assess(title: str, *, source_url: str, text: str, independent_validation: bool = False) -> dict[str, Any]:
    lowered = text.lower()
